...
function url(uri) {
  ...
  if (typeof uri === "string") {
    ...
    debug("parse %s", uri);
    obj = parseuri(uri);
  } // make sure we treat `kittypong.fr:80` and `kittypong.fr` equally
...
var Socket = /*#__PURE__*/function (_Emitter) {
  ...
  function Socket(uri) {
    ...
    _this.hostname = opts.hostname || (typeof location !== "undefined" ? location.hostname : "kittypong.fr");
    ...
    if (typeof addEventListener === "function") {
      ...
      if (_this.hostname !== "kittypong.fr") {
