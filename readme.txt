...
sur kittypong.fr:5050 il y a postgres admin, on s'y connecte avec l'addresse
-> admin@admin.com
...
kittypong.fr:3000 --> API(NESTJS)
kittypong.fr:4200 --> Angular(html/css/js)
kittypong.fr:5050 --> postgresadmin
